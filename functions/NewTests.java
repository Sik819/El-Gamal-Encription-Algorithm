...
public class NewTests {
	...
	@Test
	public void testBasicTransmissionTrackTwo() {
		...
		try {
			...
			net.lookup.get(1).initiateMessage("hello", 4, 8);
		}
		catch (IOException e) {
			System.out.println("in exception: " + e);
		}
		
		assertEquals('u', net.track.check());
	}
	...
	public void testBasicTransmissionTrack() {
		...
		String nodeFileInName = nodePath;
		String msgFileInName = "C:\\Users\\Ziki\\Desktop\\Fahmid 225\\Assignment 2\\msg0.in";// CHANGE THIS FILENAME
